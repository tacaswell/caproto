...
_incr_sends = [
    [(b"abc", b"def", b"ghi"), 0, (b"abc", b"def", b"ghi")],
    [(b"abc", b"def", b"ghi"), 1, (b"bc", b"def", b"ghi")],
    [(b"abc", b"def", b"ghi"), 3, (b"def", b"ghi")],
    [
...
records_to_check = [
    ...
    [
        "x.{}",
        ("x", "x", None, ca.RecordModifier(ca.RecordModifiers.filtered, "{}")),
    ],
    [
        "x.VAL{}",
        (
    ...
    [
        ...
        (
            ...
            "NAME",
            ca.RecordModifier(
                ca.RecordModifiers.filtered | ca.RecordModifiers.long_string,
                "{}",
            ),
        ),
    ],
